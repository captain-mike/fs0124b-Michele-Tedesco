...
//foreach che modifica l'array originale
// todo.forEach(t =>{

//     const user = users.find(u => u.id == t.userId)
//     t.userName = user.firstName
...
//con map
const newTodoArray = todo.map(t =>{
    
   
    t = {...t}//copio l'array per mantenere intatto l'originale
    const user = users.find(u => u.id == t.userId)//trovo lo user
    t.userName = user.firstName
...
// console.log(newTodoArray[0]);


//con reduce


const newTodoArrayReduce = todo.reduce((p, c)=>{
    
    
    const user = users.find(u => u.id == c.userId)//trovo lo user
...
// console.log(todo);
// console.log(newTodoArrayReduce);

//producendo un oggetto con reduce
const newTodoObjectReduce = todo.reduce((p, c)=>{
...
console.log(todo);
console.log(newTodoObjectReduce);
